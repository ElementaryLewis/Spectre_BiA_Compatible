...
{
	/*private*/   saved var skills : array<SSkill>;									//modSpectre
	
	/*private*/   saved var resistStatsItems : array<array<SResistanceValue>>;		//modSpectre
	private   saved var toxicityOffset : float;									
	/*private*/ 		var pathPointsSpent : array<int>;							//modSpectre
	/*private*/   saved var skillSlots : array<SSkillSlot>;						//modSpectre
	/*protected*/ saved var skillAbilities : array<name>;							//modSpectre
	/*private*/ 		var totalSkillSlotsCount : int;								//modSpectre
	/*private*/ 		var tempSkills : array<ESkill>;								//modSpectre
	/*private*/   saved var mutagenSlots : array<SMutagenSlot>;						//modSpectre
	/*private*/			var temporaryTutorialSkills : array<STutorialTemporarySkill>;	//modSpectre
	...
	/*private*/   saved var mutagenBonuses : array< SMutagenBonusAlchemy19 >;		//modSpectre
	private   saved var alchemy19OptimizationDone : bool;						
	
	
	/*private*/   saved var isMutationSystemEnabled : bool;							//modSpectre
	/*private*/   saved var equippedMutation : EPlayerMutationType;					//modSpectre
	/*private*/   saved var mutations : array< SMutation >;							//modSpectre
	/*private*/   saved var mutationUnlockedSlotsIndexes : array< int >;			//modSpectre
	/*private*/   saved var mutationSkillSlotsInitialized : bool;					//modSpectre
	...
	public /*final*/ function Init(ownr : CActor, cStats : CCharacterStats, isFromLoad : bool, diff : EDifficultyMode) : bool //modSpectre
	{
	...
	public /*final*/ function PostInit() //modSpectre
	{		
	...
	public /*final*/ function OnSkillMutagenUnequipped( out item : SItemUniqueId, slot : EEquipmentSlots, prevColor : ESkillColor, optional dontMerge : bool )//modSpectre
	{
		var i : int;
		var newColor : ESkillColor;
	...
	protected final function MutagensSyngergyBonusUpdate( skillGroupID : int, skillLevel : int ) //modSpectre
	{
		var i : int;
	...
	protected final function LinkUpdate(newColor : ESkillColor, prevColor : ESkillColor) //modSpectre
	{
	...
	public /*final*/ function AddSkill(skill : ESkill, isTemporary : bool)//modSpectre
	{
		var i : int;
	...
	public final function GetStat(stat : EBaseCharacterStats, optional skipLock : bool) : float	
	{
		...
		var i : int;
		return (super.GetStat(stat) );//modSpectre
	...
	public /*final*/ function EquipSkill(skill : ESkill, slotID : int) : bool//modSpectre
	{
		var idx : int;
	...
	public /*final*/ function UnequipSkill(slotID : int) : bool //modSpectre
	{
		var idx : int;
		var prevColor : ESkillColor;
		var skill : ESkill;
	...
	public /*final*/ function CanUseSkill(skill : ESkill) : bool //modSpectre
	{
		var ind : int;
	...
	public /*final*/ function IsSkillEquipped(skill : ESkill) : bool //modSpectre
	{
		var i, idx : int;
	...
	public /*final*/ function ResetCharacterDev()//modSpectre
	{
		var i : int;
		var skillType : ESkill;
