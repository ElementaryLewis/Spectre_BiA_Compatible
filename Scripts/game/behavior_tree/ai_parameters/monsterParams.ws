...
{	
	...
	default tauntDelay 			 = 5;	//modSpectre
	default forceAttackDelay 	 = 10;	//modSpectre
...
abstract class CAIBaseMonsterCombatParams extends CAICombatParameters
{
	...
	default	hitterWeight 		= 30.0f;		//modSpectre
	default	currentTargetWeight = 20.0f;		//modSpectre
	default	playerWeight		= 15.0f;		//modSpectre
