...
{
	var steelFastAP:float; //modSpectre
	var steelFastDmg:float;
	var steelFastCritChance:float;
	var steelFastCritAP:float; //modSpectre
	var steelFastCritDmg:float;
	var steelFastDPS:float; //modSpectre
	
	var steelStrongAP:float; //modSpectre
	var steelStrongDmg:float;
	var steelStrongCritChance:float;
	var steelStrongCritAP:float; //modSpectre
	var steelStrongCritDmg:float;
	var steelStrongDPS:float; //modSpectre
	
	var silverFastAP:float; //modSpectre
	var silverFastDmg:float;
	var silverFastCritChance:float;
	var silverFastCritAP:float; //modSpectre
	var silverFastCritDmg:float;
	var silverFastDPS:float; //modSpectre
	
	var silverStrongAP:float; //modSpectre
	var silverStrongDmg:float;
	var silverStrongCritChance:float;
	var silverStrongCritAP:float; //modSpectre
	var silverStrongCritDmg:float;
	var silverStrongDPS:float; //modSpectre
