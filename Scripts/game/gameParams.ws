...
import class W3GameParams extends CObject
{
	...
	public const var HEAD_SHOT_DAMAGE_BONUS : float; //modSpectre																  
	public const var BACK_ATTACK_CRIT_CHANCE_BONUS : float;			
	public const var BACK_ATTACK_DAMAGE_BONUS : float; //modSpectre														  
		...
		default HEAD_SHOT_DAMAGE_BONUS = 0.25; //modSpectre										   
		default BACK_ATTACK_CRIT_CHANCE_BONUS = 0.5;
		default BACK_ATTACK_DAMAGE_BONUS = 0.25; //modSpectre											 
	...
	public var INTERACTIVE_REPAIR_OBJECT_MAX_DURS : array<int>;									
		...
		default ITEM_DAMAGED_DURABILITY = 75;					//modSpectre
	
		default DURABILITY_ARMOR_LOSE_CHANCE = 100;
		default DURABILITY_WEAPON_LOSE_CHANCE = 100;
		default DURABILITY_ARMOR_LOSE_VALUE = 0.5;				//modSpectre
		default DURABILITY_WEAPON_LOSE_VALUE = 0.05;			//modSpectre
		default DURABILITY_WEAPON_LOSE_VALUE_HARDCORE = 0.05;	//modSpectre
	...
	private var ARMOR_COMMON_ABILITIES		: array<name>;			//modSpectre																						   
	...
	private var WEAPON_COMMON_ABILITIES		: array<name>;			//modSpectre																							  
	...
	public const var ITEM_SET_TAG_KAER_MORHEN, ITEM_SET_TAG_BEAR_MINOR, ITEM_SET_TAG_GRYPHON_MINOR, ITEM_SET_TAG_LYNX_MINOR, ITEM_SET_TAG_WOLF_MINOR, ITEM_SET_TAG_RED_WOLF_MINOR : name; //modSpectre																																								
	...
	public const var SUPERHEAVY_STRIKE_COST_MULTIPLIER : float; //modSpectre																   
	...
	public const var PARRY_STAGGER_REDUCE_DAMAGE : float; //modSpectre															 
		default PARRY_HALF_ANGLE = 180;
		default SUPERHEAVY_STRIKE_COST_MULTIPLIER = 1.5; //modSpectre													  
		default HEAVY_STRIKE_COST_MULTIPLIER = 1.25; //modSpectre
		default PARRY_STAGGER_REDUCE_DAMAGE_LARGE = 0.6f;
		default PARRY_STAGGER_REDUCE_DAMAGE_SMALL = 0.3f;
		default PARRY_STAGGER_REDUCE_DAMAGE = 0.5f; //modSpectre												
	...
	public const var OIL_DECAY_FACTOR : float; //modSpectre
	...
	public const var MAX_PLAYER_LEVEL	: int;											
		...
		default isArmorRegenPenaltyEnabled = 0; //modSpectre
		default combatStaminaRegen = -1000; //modSpectre
		default outOfCombatStaminaRegen = -1000; //modSpectre
		default combatVitalityRegen = -1000; //modSpectre
		default outOfCombatVitalityRegen = -1000; //modSpectre
		default agilityStaminaCostMult = -1000; //modSpectre
		default meleeStaminaCostMult = -1000; //modSpectre
		default signStaminaCostMult = -1000; //modSpectre
		default staminaDelay = -1000; //modSpectre
		default signCooldown = -1000; //modSpectre
